...
- Legal hearings, convictions, prison months, and return to play
- Chronological records, automatic browser saves, and JSON import/export
- Split local CSS and JavaScript files that can be reviewed independently

## Run locally

Double click index.html to play in a regular browser. Keep the css and js folders beside it. No server, packages, account, backend, API keys, or network connection are needed.
...
The package is organized into small files so each part is easy to review:

- index.html — page shell and script loading order
- css/style.css — stylesheet entry point
